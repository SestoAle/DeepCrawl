...
public class GameUI : MonoBehaviour
{
    ...
    // Update the MP text
    public void setMp(int mp, int maxMp, int color)
    {
        string colorHex = ColorUtility.ToHtmlStringRGB(colors[color]);
        mpText.text = "<color=#" + colorHex + ">MP: " + mp + "/" + maxMp + "</color>";
    }
    ...
    // it disappears. The movements are managed by the ECS. The method returns
    ...
    public void changeImagePotion(Sprite image)
    {
    ...
    // Restart game from StartScene. It is used by animation
