...
public static class OFFSET
{
    ...
    public static readonly Vector3 NorthEast = new Vector3(1, 0, 1);
    public static readonly Vector3 SouthEast = new Vector3(1, 0, -1);
    public static readonly Vector3 SouthWest = new Vector3(-1, 0, -1);
    public static readonly Vector3 NorthWest = new Vector3(-1, 0, 1);
