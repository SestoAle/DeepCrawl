...
public class InputSystem : ComponentSystem
{
    ...
    public struct Data
    {
        ...
        public SubtractiveComponent<Magic> Magic;
    }
    ...
    protected override void OnUpdate()
    {
        for (var i = 0; i < data.Length; i++)
        {
            ...
            {
                // Brained agent
                if (data.GameObject[i].CompareTag("BrainedAgent") || BoardManagerSystem.instance.doubleAgent)
                {
                ...
                else if (data.GameObject[i].CompareTag("Random"))
                {
                ...
                // BehaviorTree Agent
                else if (data.GameObject[i].CompareTag("TreeAgent"))
                {
                    PandaBehaviour tree = data.GameObject[i].GetComponent<PandaBehaviour>();
                    tree.Reset();
                    tree.Tick();
                }
                else
                // Player inputs management
                {
                    ...
                    else
                    {
                        ...
                        if (data.GameObject[i].CompareTag("Player"))
                        {
                    ...
                    {
                        PostUpdateCommands.AddComponent(data.Entity[i], new UserInput {action = 18 - 1});
                    }

                    if (Input.GetKeyDown(KeyCode.J))
                    {
                        PostUpdateCommands.AddComponent(data.Entity[i], new UserInput {action = 18});
                    } 
